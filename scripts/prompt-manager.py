...
class PromptManager:
    def __init__(self):
        ...
        self.database_id = os.getenv("NOTION_PROMPTS_DB_ID")
        
        if not self.database_id:
            print("❌ NOTION_PROMPTS_DB_ID not found in .env")
            print("Please add your database ID to the .env file")
            print("Example: NOTION_PROMPTS_DB_ID=bf9c35d5e8a646c7b5476c57a91234ef")
            return
